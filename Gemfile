...
#gem "paperclip", "~> 3.0"          #upload and organizer images
gem "paperclip", :git => "git://github.com/thoughtbot/paperclip.git", :ref => "e421bc1b0d5806f53be8a664c5f3c70c2e285e7e" # while problems with calling identify
