class MailMessage < ActiveRecord::Base
  ...
  attr_accessible :from_email, :to_email, :ip, :user_agent, :referer, :event_id, :organizer_id, :mail_body, :from_first_name, :from_last_name, :to_name, :from_phone, :current_page
