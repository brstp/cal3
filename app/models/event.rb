...
class Event < ActiveRecord::Base
  ...
  attr_accessible :subject, :intro, :description, :street, :loc_descr, :lat, :lng, :municipality_id, 
                  ...
                  :image1_caption, :image1_url, :image1_delete, :image2_caption, :image2_url, :image2_delete, :image3_caption, :image3_url, :image3_delete, :init_lat, :init_lng, :init_zoom, :organizer_id
