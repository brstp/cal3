class Event < ActiveRecord::Base
  ...
  attr_accessible :subject, :intro, :description, :start_datetime, :stop_datetime, :street, :zip, :city, :loc_descr, :lat, :lng, :municipality_id

  validates_presence_of :subject, :description, :stop_datetime, :municipality_id, :start_datetime
